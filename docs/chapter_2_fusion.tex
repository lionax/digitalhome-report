...
Nach der Fusion aller Ideen kann ein einheitliches Branding für DigitalHome festgelegt werden, welches für Entscheidungen zur Gestaltung weiterer Unterseiten benötigt wird.
Schrägen haben generell eine Neigung von exakt 15° aus der Vertikalen nach rechts. Sie werden zum abtrennen von einzelnen Inhaltsbereichen verwendet.
Inhalt selbst ist in Rechtecken untergebracht. Ein Inhaltsbereich besteht aus einem Überschriften Block links und einem Inhaltsblock rechts. Der Inhaltsblock kann verschiedene Breiten annehmen und aus verschiedenen Inhaltstypen bestehen. Darunter fallen Tabellen, Kacheln und Text, jedoch keine Bilder. Für diese ist ein extra Bildbereich vorgesehen, der vollständig mit diesem ausgefüllt wird (Siehe Abbildung \ref{inno_Comp3}.
